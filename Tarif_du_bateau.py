...
Votre programme doit lire l’âge d’une personne 
Et afficher soit « Tarif réduit » si cette personne a strictement
Moins de 21 ans, soit « Tarif plein » dans le cas contraire.  
Code :
age = int(input())
if age < 21:
    print("Tarif réduit")
